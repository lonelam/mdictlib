//! The MDict major version 2 wire grammar.
//!
//! Version 2 declares its geometry in 64-bit big-endian fields, carries a
//! checksummed 44-byte keyword header, compresses its keyword metadata, and
//! terminates its key summaries. One narrowly signaled legacy variant is also
//! accepted; see [`keyword`] for its exact preconditions.
//!
...
/// Parses a version 2 file into the shared validated layout.
///
/// # Errors
///
